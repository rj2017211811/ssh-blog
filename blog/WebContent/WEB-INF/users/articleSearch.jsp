								...
								<div class="title1">
									<nav aria-label="Page navigation">
										<ul class="pagination">
											...
											<c:if test="${pageNow>1 }">
												<li><a
													href="${pageContext.request.contextPath }/blog.do?flag=searchArticle&blogName=${blogName }&pageNow=${pageNow-1 }"
											...
											<c:forEach begin="1" end="${pageCount }" var="i">
												...
												<c:if test="${pageNow!=i }">
													<li><a
														href="${pageContext.request.contextPath }/blog.do?flag=searchArticle&blogName=${blogName }&pageNow=${i }">${i }</a></li>
												</c:if>
											</c:forEach>

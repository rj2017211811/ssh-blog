					...
					<div class="rightInfo">
						<div class="row">
							<div class="col-md-12" class="sort">
								...
								<div class="content" class="col-md-12">
									<label class="tag1"><a href="#">Javascript</a></label> <label
										class="tag2"><a href="#">Bootstrap</a></label> <label
										class="tag3"><a href="#">Java</a></label> <label class="tag4"><a
										href="#">Linux</a></label> <label class="tag5"><a href="#">数据库</a></label>
									<label class="tag6"><a href="#">cookie</a></label>
								</div>
								...
								<div class="title1">
									<nav aria-label="Page navigation">
										<ul class="pagination">
											...
											<c:if test="${pageNow>1 }">
												<li><a
													href="${pageContext.request.contextPath }/blog.do?flag=articleCategory&blogsortId=${blogsortId }&pageNow=${pageNow-1 }"
											...
											<c:forEach begin="1" end="${pageCount }" var="i">
												...
												<c:if test="${pageNow!=i }">
													<li><a
														href="${pageContext.request.contextPath }/blog.do?flag=articleCategory&blogsortId=${blogsortId }&pageNow=${i }">${i }</a></li>
												</c:if>
											</c:forEach>
